...
var xmlData = XMLData("Sitemap_bestanden/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Deze tabel bevat shapedetails'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Label</TH><TH>Waarde</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Er zijn geen details beschikbaar.";
		}
	}
