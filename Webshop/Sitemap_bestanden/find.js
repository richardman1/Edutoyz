...
var strShapeName	= "Shapenaam";
var strShapeText	= "Shapetekst";
var strProps		= "Shapegegevens";
var strResults		= "Zoekresultaten voor:";

var strShape	= "Shapenaam:";
var strNoCustomPropertiesToDisplayText = "Houd CTRL ingedrukt en klik op een shape in de tekening om de details weer te geven.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Geen treffers gevonden.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Shapedetails weergeven/verbergen" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
